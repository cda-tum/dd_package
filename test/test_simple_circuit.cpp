...
//		dotfilenameStream.str("");
//		dotfilenameStream << "qmdd_before_gate_" << (gate + 1) << ".dot";
//        dd::export2Dot(qmddState, dotfilenameStream.str(), false, true, true, false, true, false);
//		dotfilenameStream.str("");
//		dotfilenameStream << "limdd_before_gate_" << (gate + 1) << ".dot";
