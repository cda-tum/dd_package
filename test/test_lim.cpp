...
TEST(LimTest, getVectorLIMDD4) {
    ...
    auto            e1  = dd->makeDDNode(1, std::array{dd::vEdge::zero, e0}, false, lim);
...
TEST(LimTest, getVectorLIMDD5) {
    ...
    auto            e1   = dd->makeDDNode(1, std::array{dd::vEdge::zero, e0}, false, lim1);
...
TEST(LimTest, getVectorLIMDD9) {
    ...
    // make edge ZI|0>|+>
    dd::LimEntry<>* lim = new dd::LimEntry<>("IZ");
    auto            e1  = dd->makeDDNode(1, std::array{e0, dd::vEdge::zero}, false, lim);
